...
Export-ModuleMember -Function Add-XrmAlternateKey -Alias *;

Register-ArgumentCompleter -CommandName Add-XrmAlternateKey -ParameterName "EntityLogicalName" -ScriptBlock {
