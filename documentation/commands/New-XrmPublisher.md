...
```Powershell 
New-XrmPublisher [[-XrmClient] <ServiceClient>] [-UniqueName] <String> [-DisplayName] <String> [-Prefix] <String> [-OptionValuePrefix] <Int32> [[-Description] <String>] [<CommonParameters>]
``` 

## Examples

```Powershell 
$publisher = New-XrmPublisher -UniqueName "contoso" -DisplayName "Contoso Ltd" -Prefix "cts" -OptionValuePrefix 28100;
``` 
