...
```Powershell 
Get-XrmAllEntityMetadata [[-XrmClient] <ServiceClient>] [[-Filter] {Entity | Default | Attributes | Privileges | Relationships | All}] 
[[-RetrieveAsIfPublished] <Boolean>] [<CommonParameters>]
``` 
