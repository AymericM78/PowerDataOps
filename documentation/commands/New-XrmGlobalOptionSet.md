# Command : `New-XrmGlobalOptionSet` 
...
```Powershell 
New-XrmGlobalOptionSet [[-XrmClient] <ServiceClient>] [-OptionSetMetadata] <OptionSetMetadataBase> [[-SolutionUniqueName] <String>] [<CommonParameters>]
``` 
