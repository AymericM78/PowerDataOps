...
```Powershell 
New-XrmAlternateKey [[-XrmClient] <ServiceClient>] [-EntityLogicalName] <String> [-EntityKeyMetadata] <EntityKeyMetadata> [[-SolutionUniqueName] <String>] [<CommonParameters>]
``` 
