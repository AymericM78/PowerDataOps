# Command : `New-XrmManyToManyRelationship` 
...
```Powershell 
New-XrmManyToManyRelationship [[-XrmClient] <ServiceClient>] [-ManyToManyRelationship] <ManyToManyRelationshipMetadata> [-IntersectEntityName] <String> [[-SolutionUniqueName] <String>] 
[<CommonParameters>]
``` 
