# Command : `New-XrmOneToManyRelationship` 
...
```Powershell 
New-XrmOneToManyRelationship [[-XrmClient] <ServiceClient>] [-OneToManyRelationship] <OneToManyRelationshipMetadata> [-Lookup] <LookupAttributeMetadata> [[-SolutionUniqueName] <String>] 
[<CommonParameters>]
``` 
...
New-XrmOneToManyRelationship -OneToManyRelationship $rel -Lookup $lookup;
``` 
