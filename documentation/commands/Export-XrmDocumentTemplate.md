...
Export-XrmDocumentTemplate [[-XrmClient] <ServiceClient>] [-TemplateName] <String> [[-AssociatedEntityLogicalName] <String>] [-OutputPath] <String> [<CommonParameters>]
``` 

## Examples

```Powershell 
Export-XrmDocumentTemplate -TemplateName "Invoice Template" -OutputPath "C:\Temp\InvoiceTemplate.docx";

Export-XrmDocumentTemplate -TemplateName "Expense Template" -AssociatedEntityLogicalName "sample_expense" -OutputPath "C:\Temp\ExpenseTemplate.docx";
``` 
