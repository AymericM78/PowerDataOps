...
```Powershell 
New-XrmSolution [[-XrmClient] <ServiceClient>] [-UniqueName] <String> [-DisplayName] <String> [-PublisherReference] <EntityReference> [[-Version] <String>] [[-Description] <String>] 
[<CommonParameters>]
``` 
